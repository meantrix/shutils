...
shutils - program to do something

# SYNOPSIS

**shutils** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**shutils** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **shutils** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**shutils** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    shutils. See **foo.conf**(5) for further details.
...
**shutils** provides some return codes, that can be used in scripts:
